...
A identidade de Roy é um corolário do lema de Shephard, resultado obtido pela derivação da função de utilidade indireta:\footnote{Pela regra da cadeia: $\nabla_p v(p, e(p, \bar{u})) = \nabla_p v + \frac{\partial v}{\partial w} \nabla_p e$.}
\[
...
\begin{cases}
  ...
  P(D) = P(\lnot E \land I) &= P(\lnot E \mid I) \cdot P(I) \\
  ...
  Critério \(1\): 
  \begin{itemize}
    \item \(P(E \mid I) = 0.90\) (\(\implies P(\lnot E \mid I) = 0.10\))
    \item \(P(E \mid \lnot I) = 0.10\) (\(\implies P(\lnot E \mid \lnot I) = 0.90\))  
  \end{itemize}
...
\begin{cases}
  ...
  Critério \(2\): 
  \begin{itemize}
    \item \(P(E \mid I) = 0.95\) (\(\implies P(\lnot E \mid I) = 0.05\))
    \item \(P(E \mid \lnot I) = 0.15\) (\(\implies P(\lnot E \mid \lnot I) = 0.85\))  
  \end{itemize}
...
\begin{exercise}
  ...
  \caption{Fonte: Funções de utilidade exponencial para vários parâmetros de aversão ao risco. Fonte: \textcite[fig. 1]{Wood2015}; destaque-se que estes autores utilizam a função $U(x) = \frac{1-e^{-rx}}{1-e^{-r}}$.}
  \label{exponencial}
\end{figure}
