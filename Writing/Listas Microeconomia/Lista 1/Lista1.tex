...
% Title (fill manually)
% ------------------------------------------------
\title{Lista 1 -- Teoria Microeconômica}
...
\begin{definition}[Preferências Racionais]
  ...
  Mas-Collell et al (1995) definem \emph{preferências racionais} \(\succeq\) como
...
\begin{definition}[Função utilidade representante de preferências racionais]
  ...
  Vide definição \textbf{1.B.2.} em @Mas-Colell1995, uma função
...
\begin{proposition}
  ...
  \begin{proof}
    ...
    A demonstração da proposição \textbf{1.B.2} em @Mas-Colell1995 segue o
